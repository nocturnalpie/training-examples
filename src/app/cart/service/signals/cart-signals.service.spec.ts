...
import { CartSignalsService, SHIPPING } from './cart-signals.service';
import { Product } from '../../../products/product';

describe('CartSignalsService', () => {
  let service: CartSignalsService;
  const product1: Product = { id: 1, name: '', price: 10 };
  const product2: Product = { id: 2, name: '', price: 14 };

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(CartSignalsService);
  });
